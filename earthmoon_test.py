...
# Modified by Raunak Bhojwani for another test
...
def main():
    ...
    while not window_closed(): 
        ...
        moon.update_velocity(-0.25, -0.00004, TIMESTEP * TIME_SCALE)  # This is my new addition. I update the moon's velocity and position
        moon.update_position(TIMESTEP * TIME_SCALE)                   # so that the moon moves and I can check the body class' methods
